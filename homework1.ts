...
const faculties: Array<Faculties> = [
    {
        id: 1,
...
interface IPeoplesWhoWorkedOnTheMovie{
    director: string,
    writer: string,
    actors: string[],
}

interface IMovies extends IPeoplesWhoWorkedOnTheMovie{
    readonly id: 1 | 2,
    title: string,
    readonly year: 2021 | 2011,
    released?: string,
    runtime: string,
    genre:  Array<string>,
    plot: string,
